...
% compute dual variable using lsqminnorm
A_lsqminnorm = [C_grad', F_grad'];
b_lsqminnorm = [Lx' - Gx' * sigma;...
                Lu' - Gu' * sigma;...
                Lp' - Gp' * sigma  - PHIp' * gamma;...
                Lw'                - PHIw' * gamma];
A_b_lsqminnorm_FunObj = Function('A_b_lsqminnorm_FunObj',...
    {sigma, gamma,...
    Lx, Lu, Lp, Lw,...
    Gx, Gu, Gp,...
    Cx, Cu, Cp, Cw,...
    ...
    'PHIp', 'PHIw'},...
    {'A_lsqminnorm', 'b_lsqminnorm'});
FunObj.A_b_lsqminnorm = A_b_lsqminnorm_FunObj.map(nStages);
